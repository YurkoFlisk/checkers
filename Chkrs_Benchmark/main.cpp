...
int main(void)
{
	int white_level, black_level, timer, overall_time(0), game_length(0);
	Move move;
	...
	ai_log << "Overall time elapsed: " << overall_time << "ms\n";
	ai_log << "Average thinking time: " << (float)(overall_time) / game_length << "ms\n";
	ai_log.close();
	return 0;
}